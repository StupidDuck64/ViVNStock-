...
# ===== VNStock Schemas =====
echo "Registering VNStock market data schemas..."
register_schema "${SCHEMAS_DIR}/vnstock-ohlc-stock-value.avsc" "ohlc_stock-value"
register_schema "${SCHEMAS_DIR}/vnstock-ohlc-derivative-value.avsc" "ohlc_derivative-value"
register_schema "${SCHEMAS_DIR}/vnstock-ohlc-index-value.avsc" "ohlc_index-value"
register_schema "${SCHEMAS_DIR}/vnstock-quote-value.avsc" "quote-value"
register_schema "${SCHEMAS_DIR}/vnstock-expected-price-value.avsc" "expected_price-value"
register_schema "${SCHEMAS_DIR}/vnstock-security-def-value.avsc" "security_def-value"
echo "VNStock schemas registered!"
