...
def build_fact_customer_engagement(spark: SparkSession, raw_events: DataFrame | None) -> DataFrame:
    # raw_events is required to aggregate daily engagement behaviour
    ...
    # Roll up to daily grain per user-product pair
    ...
    # Join dimensions to replace natural keys with surrogate keys in the fact
