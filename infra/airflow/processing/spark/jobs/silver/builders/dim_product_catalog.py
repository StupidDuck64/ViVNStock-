"""Builder for the product dimension (`dim_product_catalog`) using SCD Type 2."""
...
def build_dim_product_catalog(spark: SparkSession, _: DataFrame | None) -> DataFrame:
    # Read the Bronze CDC table and extract product state from the JSON payload
    ...
    # Build SCD2 versioned rows: valid_from / valid_to whenever attributes change
    ...
    # Generate a stable surrogate key for each versioned record
    return (scd
